...
Abrí `index.html` para visualizar el proyecto.
...
- **CSS3 / SASS** para los estilos y el diseño responsivo
- **GitHub Pages** para la publicación del proyecto

## 📁 Estructura del proyecto
- `index.html`
- `pages/`
- `css/` (incluye `main.css`)
- `sass/` (fuente SASS)
- `img/`
- `README.md`

## ⚽ Descripción
El sitio web ofrece una experiencia visual atractiva sobre el **Mundial 2026**, incluyendo:
- Información sobre las **sedes y estadios**
- Detalles de los **equipos participantes**
- Sección de **grupos** (con tarjetas tipo flip)
- Sección de **sponsors**
- Calendario/curiosidades (según el contenido del sitio)
