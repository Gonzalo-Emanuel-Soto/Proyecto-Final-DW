...
- **CSS3 / SASS** para los estilos y diseño responsivo
- **GitHub Pages** para la publicación del proyecto

## 📁 Estructura del proyecto
- `index.html`
- `pages/` (secciones del sitio: grupos, grupo A, sponsors, etc.)
- `css/` (por ejemplo: `main.css`)
- `sass/` (archivos `.scss` del diseño)
- `img/` (imágenes y flags)
- `README.md`
